...
const data = {
  nl: {
    ...
    services: [
      ...
      { icon: "📋", title: "Programma- en projectmanagement", description: "Complexe verandertrajecten van begin tot eind realiseren. Voor en samen met de klant.", features: ["Programmamanagement", "Agile & Waterval", "Transition Support Office", "Risicomanagement"], color: "its-green-mid" },
  ...
  en: {
    ...
    services: [
      ...
      { icon: "📋", title: "Programme & Project Management", description: "Delivering complex change initiatives from start to finish, for and with the client.", features: ["Programme management", "Agile & Waterfall", "Transition Support Office", "Risk management"], color: "its-green-mid" },
