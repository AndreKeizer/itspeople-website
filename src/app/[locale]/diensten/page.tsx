  ...
  en: {
    services: [
      ...
      },
      {
        ...
        description: "The ITs Target Operating Model: mapping and optimising services, processes, governance and IT.",
        features: ["Process architecture", "Value stream analysis", "Supply chain integration", "Automation"],
        detail: "Processes are the nervous system of every organisation. Our process managers map the current and desired situation, identify improvement opportunities and guide the implementation of optimised processes. From value stream analyses to supply chain integrations, we ensure that processes are effective, efficient and future-proof.",
      },
      {
        image: "/images/services/data-management.jpg",
        title: "Data Management",
        description: "The ITs Productivity Centre: structure, quality, visualisation and data-driven insights.",
        features: ["Data governance", "Data quality", "Visualisation & dashboards", "AI & Analytics"],
        detail: "Data is the fuel for modern organisations. Our ITs Productivity Centre helps organisations structure their data, guarantee quality and generate insights that improve decision-making. From data governance frameworks to advanced dashboards and AI applications, we make data work for your organisation.",
      },
      {
        image: "/images/services/quality-assurance.jpg",
        title: "Testing & Quality Assurance",
        description: "Risk management and cost savings through professional quality assurance of systems and processes.",
        features: ["Test strategy & policy", "Test coordination", "Test automation", "DevOps testing"],
        detail: "Quality is not an afterthought but a strategic tool. Our testing professionals ensure that systems and processes meet the required standards. From test strategy to automation, from functional testing to performance and security testing. We help organisations manage risks and save costs by identifying errors early.",
      },
    ],
