...
const data = {
  nl: {
    ...
    indicators: [
      ...
      { stat: "12+", label: "Jaar gemiddelde seniority" },
      { stat: "€500M+", label: "Programme value delivered" },
      { stat: "€28M", label: "Gemiddelde programmawaarde" },
    ],
    ...
    aiImplementationDesc: "Custom AI solutions geïntegreerd met uw bestaande ERP-systemen. ML-driven business intelligence en process automation voor measurable impact.",
    ...
    ctaStats: "150+ succesvolle projecten • €500M+ programme value • 95% client satisfaction",
  ...
  en: {
    ...
    indicators: [
      ...
      { stat: "12+", label: "Years average seniority" },
      { stat: "€500M+", label: "Programme value delivered" },
      { stat: "€28M", label: "Average programme value" },
    ],
    ...
    aiImplementation: "AI Implementation & Integration",
    aiImplementationDesc: "Custom AI solutions integrated with your existing ERP systems. ML-driven business intelligence and process automation for measurable impact.",
    aiReadinessHeading: "AI Readiness Assessment",
    ...
    ctaStats: "150+ successful projects • €500M+ programme value • 95% client satisfaction",
