      ...
      <section className="relative pt-32 pb-20 bg-gradient-to-br from-its-dark via-its-deep to-its-dark">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            <span className="text-its-green text-sm font-semibold tracking-wider uppercase">Contact</span>
            ...
            <p className="text-white/60 text-lg leading-relaxed max-w-2xl">
              Benieuwd wat ITsPeople voor uw organisatie kan betekenen? Neem contact op, wij denken graag met u mee.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              {submitted ? (
                <div className="bg-white rounded-2xl p-12 border border-its-green/20 text-center">
                  ...
                  <h2 className="text-2xl font-bold text-its-charcoal mb-4">Bedankt voor uw bericht!</h2>
                  <p className="text-its-gray-mid">Wij nemen zo snel mogelijk contact met u op. Meestal binnen 1 werkdag.</p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-8 border border-its-gray-light/30">
                  <h2 className="text-2xl font-bold text-its-charcoal mb-6">Stuur ons een bericht</h2>
                  <div className="grid md:grid-cols-2 gap-4 mb-4">
                    <div>
                      <label className="block text-sm font-medium text-its-charcoal mb-1">Naam *</label>
                    ...
                    <div>
                      <label className="block text-sm font-medium text-its-charcoal mb-1">E-mail *</label>
                  ...
                  <div className="grid md:grid-cols-2 gap-4 mb-4">
                    <div>
                      <label className="block text-sm font-medium text-its-charcoal mb-1">Telefoon</label>
                    ...
                    <div>
                      <label className="block text-sm font-medium text-its-charcoal mb-1">Organisatie</label>
                  ...
                  <div className="mb-4">
                    <label className="block text-sm font-medium text-its-charcoal mb-1">Onderwerp</label>
                    <select value={formData.onderwerp} onChange={(e) => setFormData({ ...formData, onderwerp: e.target.value })} className="w-full px-4 py-3 rounded-lg border border-its-gray-light/30 bg-its-warm text-its-charcoal text-sm focus:outline-none focus:border-its-green/50">
                      ...
                      <option value="cases">Cases & referenties</option>
                      <option value="samenwerking">Samenwerking</option>
                      <option value="werken-bij">Werken bij ITsPeople</option>
                      <option value="anders">Anders</option>
                    </select>
                  </div>
                  <div className="mb-6">
                    <label className="block text-sm font-medium text-its-charcoal mb-1">Bericht *</label>
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="space-y-8">
              <div>
                <h2 className="text-2xl font-bold text-its-charcoal mb-6">Contactgegevens</h2>
                <div className="space-y-4">
                  <div className="flex items-start gap-4 p-4 rounded-xl bg-white border border-its-gray-light/30">
                    <span className="text-2xl">📧</span>
                    <div>
                      <p className="font-bold text-its-charcoal text-sm">E-mail</p>
                  ...
                  <div className="flex items-start gap-4 p-4 rounded-xl bg-white border border-its-gray-light/30">
                    <span className="text-2xl">📞</span>
                    <div>
                      <p className="font-bold text-its-charcoal text-sm">Telefoon</p>
                  ...
                  <div className="flex items-start gap-4 p-4 rounded-xl bg-white border border-its-gray-light/30">
                    <span className="text-2xl">📍</span>
                    <div>
                      <p className="font-bold text-its-charcoal text-sm">Adres</p>
                  ...
                  <div className="flex items-start gap-4 p-4 rounded-xl bg-white border border-its-gray-light/30">
                    <span className="text-2xl">💼</span>
                    <div>
                      <p className="font-bold text-its-charcoal text-sm">LinkedIn</p>
              ...
              <div className="relative rounded-2xl overflow-hidden aspect-[4/3]">
                <Image src="/images/building.jpg" alt="ITsPeople kantoor Zaltbommel" fill className="object-cover" />
                <div className="absolute inset-0 bg-gradient-to-t from-its-dark/50 to-transparent" />
                <div className="absolute bottom-6 left-6">
                  <p className="text-white font-bold">Ons kantoor</p>
                  <p className="text-white/60 text-sm">Zaltbommel</p>
                </div>
              </div>
            </motion.div>
          </div>
