  ...
  sectors: [
    {
      ...
      items: [
        ...
        "Compliancemonitoring op uitvoeringsprocessen (UWV, DUO, Belastingdienst, ministeries)",
  ...
  sectors: [
    {
      ...
      items: [
        ...
        "Compliance monitoring on execution processes (UWV, DUO, Tax Authority, ministries)",
